// TODO: Fix box to enable minting of VUSD
        ...
        <div className="border-t border-gray-200">
          <dl>
            <div className="px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-2 sm:px-6">
              <dt className="text-sm font-medium text-gray-500">VUSD in Your Wallet</dt>
              <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-start-3">$1,500,000</dd>
            </div>
