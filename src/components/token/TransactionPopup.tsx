...
/* @TODO: Add state manager and complete this popup */ 

// const SettingsPopup: React.FC<TransactionPopupProps> = ({ isOpen, onClose, onSelect }) => {
...
//               <button
//                 key={slippage}
//                 className={`py-2 px-4 ${selectedSlippage === slippage ? 'bg-blue-500' : 'bg-blue-300'} text-white w-1/4 font-bold rounded-lg`}
